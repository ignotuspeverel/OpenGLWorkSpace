...
void Mesh::createOBBMesh(const glm::vec3& center, const glm::vec3& halfSize, const glm::mat3& rotation)
{
    ...
    for (int i = 0; i < 8; ++i) {
        ...
        vertices[i] = center + rotation * offset;
    }

    for (const auto& v : vertices) {
        _vertexPositions.push_back(v);
    }
